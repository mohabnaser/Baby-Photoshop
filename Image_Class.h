...
// stb_image header definitions (implementation in stb_image_impl.cpp)
#include "stb_image.h"
...
public:
    ...
    /**
     * @brief Gets the const pixel value at the specified position and channel.
     *
     * @param x The x-coordinate of the pixel.
     * @param y The y-coordinate of the pixel.
     * @param c The color channel index (0 for red, 1 for green, 2 for blue).
    ...
    /**
     * @brief Overloaded function call operator to access and modify pixels.
     *
     * @param row The row index of the pixel.
     * @param col The column index of the pixel.
     * @param channel The color channel index (0 for red, 1 for green, 2 for blue).
